...
#кандидат а удаление
    ...
    state: help
        a: Узнай оптимальное время для установки будильника!  Просто скажи - "Будильник." || tts = "Я задам вам пару вопросов и посоветую оптимальное время установки будильника на следующий день!  Просто скажи - будильник", ttsEnabled = true, ssmlEnabled = false
        a: Познакомся с утренним расписанием известных людей. Просто скажи - "Рутина." || tts = "А для того, чтобы познакомиться с утренней рутином известных людей, скажи - рутина", ttsEnabled = true, ssmlEnabled = false 
        go!: /newNode_5
        script:
            var reply = {
                "type":"text",
